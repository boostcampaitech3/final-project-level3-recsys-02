...
from models.metapath2vec import Metapath2VecTrainer
from models.sampler import consrtruct_graph, create_metapath
from models.util import remap_id
...
if __name__ == '__main__':
    ...
    parser.add_argument('--metapath_filename', type=str, default='metapath.txt', help='random seed (default: 42)')    
    parser.add_argument('--embed_filename', type=str, default='metapath_embeddings', help='random seed (default: 42)')
    parser.add_argument('--num_walks_per_node', type=int, default=100, help='random seed (default: 42)')
